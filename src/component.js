                  ...
                  {this.getModifierValue('address') && (
                    <li className={style['contacts-list__item']}>
                      {!this.getOptionValue('hidden-address-title') && (
                        <Text bind="address-title" className={classNames(style.contacts__title,this.ui('ui-heading'))} tagName="h3" />
                      )}
                      <Text bind="address-content" className={classNames(style.contacts__desc, style['contacts__desc--adress'],this.ui('ui-body'))} tagName="p" />
                    </li>
                  )}
                  {this.getModifierValue('phone') && (
                    <li className={style['contacts-list__item']}>
                      {!this.getOptionValue('hidden-phone-title') && (
                        <Text bind="phone-title" className={classNames(style.contacts__title,this.ui('ui-heading'))} tagName="h3" />
                      )}
                      <Text bind="phone-link" className={classNames(style.contacts__desc, style['contacts__desc--phone'],this.ui('ui-body'))} tagName="p" />
                    </li>
                  )}
                  {this.getModifierValue('email') && (
                    <li className={style['contacts-list__item']}>
                      {!this.getOptionValue('hidden-email-title') && (
                        <Text bind="email-title" className={classNames(style.contacts__title,this.ui('ui-heading'))} tagName="h3" />
                      )}
                      <Text bind="email-link" className={classNames(style.contacts__desc, style['contacts__desc--email'],this.ui('ui-body'))} tagName="p" />
                    </li>
                  )}
                </ul>
                {this.getModifierValue('social') && (
