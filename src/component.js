    ...
    return (
      <article className={classNames(style.item, className)}>
        ...
        <div className={style.item__inner}>
          <Image
            wrapperClassName={classNames(style['item__pic-link'], this.ui('ui-picture-wrapper'))}
            ...
            resize={{disable: true}}
          />
          <Text tagName="h2" className={classNames(style.item__title, this.ui('ui-heading'))} bind={`team[${index}].name`} />
          <Text tagName="p" className={classNames(style.item__position, 'caption')} bind={`team[${index}].position`} />
          {_.get('member-desc')(modifier) && (
            <Text tagName="p" className={classNames(style.item__desc, this.ui('ui-body'))} bind={`team[${index}].description`} />
          )}
          ...
          {this.getModifierValue('block-button') && (
            <div className={classNames(style['btns-group'], this.ui('ui-btns-group'))}>
              <div className={classNames(style['btns-group__inner'], this.ui('ui-btns-group__inner'))}>
                <Button className={this.ui('ui-btns-group__item')} buttonClassName={style.button} linkClassName={style.link} bind="cta" />
              </div>
            </div>
          )}
        </div>
