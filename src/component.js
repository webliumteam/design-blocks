...
class Block extends React.Component {
      ...
      <li className={classNames(style.list__item, className)}>
        ...
        {this.getModifierValue('icon') && (
          <div className={classNames(style['list__item-icon'], {[style['list__item-icon--counter-none']]: collectionIcon})}>
            {collectionIcon && <Icon bind={`collection[${index}].item_icon`} />}
          </div>
        )}
        <Text tagName="span" className={style['list__item-text']} bind={`collection[${index}].item_heading`} />
      </li>
    )
  }
  ...
  render() {
    ...
    const arrange = this.getModifierValue('arrange_elements')
    ...
    return (
      <section className={classNames(style.section, arrange && style['section--reverse'])}>
        <div className={style.section__inner}>
          ...
          {!this.getOptionValue('title-in-content') && <Text tagName="h1" className={style.title} bind="title" />}
          ...
          <div className={style.content}>
            ...
            <div className={style.content__main}>
              {this.getOptionValue('title-in-content') && <Text tagName="h1" className={style.title} bind="title" />}
              {this.getModifierValue('body') && <Text tagName="p" className={style.content__text} bind="body" />}
              <Collection
