...
class Block extends React.Component {
        ...
        {this.getModifierValue('item_icon') && (
          <div className={style['item__icon-wrapper']}>
            <Icon
              ...
              bind={`collection[${index}].item_icon`}
            />
          </div>
        )}
        <div className={style.item__info}>
          ...
          {this.getModifierValue('item_price') && (
            <div className={style['item__price-wrapper']}>
              <Text
                tagName="p"
                className={classNames(style.item__price, 'heading-lg')}
                bind={`collection[${index}].item_price`}
              />
              {this.getModifierValue('item_caption') && (
                <Text
                  tagName="p"
                  className={classNames(style.item__caption, 'caption')}
                  bind={`collection[${index}].item_caption`}
                />
              )}
            </div>
          )}
  ...
  render() {
    ...
    const withoutButton = !this.getModifierValue('item_button')
      ? css['section--without-button']
      : ''
    const withoutPrice = !this.getModifierValue('item_price') ? css['section--without-price'] : ''
    const withoutPeriod = !this.getModifierValue('item_caption')
      ? css['section--without-period']
      : ''

    return (
      <section
        className={classNames(css.section, withoutIcon, withoutButton, withoutPrice, withoutPeriod)}
      >
        <div className={css.section__inner}>
          <div className={css.section__header}>
            ...
            {this.getModifierValue('subtitle') && (
              <Text
                tagName="p"
                className={classNames(css.subtitle, 'subtitle', 'text-center')}
                bind="subtitle"
              />
            )}
          </div>
