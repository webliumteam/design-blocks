...
Block.modifierScheme = {
  ...
  heading: {defaultValue: false, label: 'Company title', type: 'checkbox', sortOrder: 30},
  subheading: {defaultValue: false, label: 'Company description', type: 'checkbox', sortOrder: 40},
  text: {defaultValue: true, label: 'Company main text', type: 'checkbox', sortOrder: 50},
  'social-icons': {defaultValue: true, label: 'Social media buttons', type: 'checkbox', sortOrder: 60},
  button: {defaultValue: false, label: 'Button', type: 'checkbox', sortOrder: 70},
  'additional-button': {defaultValue: true, label: 'Additional button', type: 'checkbox', sortOrder: 80},
