...
class Wireframe extends React.Component {
  ...
  collectionItem = ({index, children, className}) => {
    ...
    const showMainText =
      this.getModifierValue('item-title') || this.getModifierValue('item-body')
        ...
        {showMainText && (
          <div className={style.item__text}>
            {this.getModifierValue('item-title') && (
              <Text
                tagName="h3"
                className={classNames(style.item__heading, this.ui('ui-heading'))}
            ...
            <li className={style.advantages__item}>
              {this.getModifierValue('list-icon') && (
                <div className={style.advantages__icon}>
                  <Icon
                    bind={`collection[${index}].advantages[0].icon`}
              ...
              <Text
                tagName="p"
                className={classNames(style.advantages__desc, this.ui('ui-body'))}
...
Wireframe.modifierScheme = {
  ...
  button: {defaultValue: false, label: 'Additional button (link)', type: 'checkbox', sortOrder: 70},
  'additional-button': {
    defaultValue: false,
    label: 'Button (link)',
    type: 'checkbox',
