...
Block.modifierScheme = {
  ...
  heading: {defaultValue: false, label: 'Company title', type: 'checkbox', sortOrder: 20},
  subheading: {defaultValue: false, label: 'Company description', type: 'checkbox', sortOrder: 30},
  text: {defaultValue: true, label: 'Company main text', type: 'checkbox', sortOrder: 40},
  'social-icons': {defaultValue: true, label: 'Social media buttons', type: 'checkbox', sortOrder: 50},
  button: {defaultValue: false, label: 'Button', type: 'checkbox', sortOrder: 60},
  'additional-button': {defaultValue: true, label: 'Additional button', type: 'checkbox', sortOrder: 70},
  'top-caption': {defaultValue: false, label: 'Top caption', type: 'hidden', sortOrder: 80},
