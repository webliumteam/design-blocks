...
Block.modifierScheme = {
  ...
  subtitle: {defaultValue: false, label: 'Block description', type: 'checkbox', sortOrder: 30},
  heading: {defaultValue: false, label: 'Text heading ', type: 'checkbox', sortOrder: 40},
  subheading: {defaultValue: false, label: 'Text subheading ', type: 'checkbox', sortOrder: 50},
  text: {defaultValue: true, label: 'Main text', type: 'checkbox', sortOrder: 60},
