...
Block.modifierScheme = {
  ...
  category: {defaultValue: true, label: 'Post category', type: 'checkbox', sortOrder: 20},
  subtitle: {defaultValue: true, label: 'Post subtitle', type: 'checkbox', sortOrder: 30},
  avatar: {defaultValue: true, label: 'Post author photo', type: 'checkbox', sortOrder: 40},
  name: {defaultValue: true, label: 'Post author name', type: 'checkbox', sortOrder: 50},
  date: {defaultValue: true, label: 'Post publication date', type: 'checkbox', sortOrder: 60},
  divider: {defaultValue: true, label: 'Decorator divider', type: 'hidden'},
  time: {defaultValue: true, label: 'Post read time', type: 'checkbox', sortOrder: 70},
