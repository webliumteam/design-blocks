...
import Component from 'wireframe-series-2-pricing_old/src/component'
import style from './style.css'

import defaultOptions from 'wireframe-series-2-pricing_old/src/options.json'
...
ExtendedWireframe.defaultContent = {
  ...
  products: {
    ...Component.defaultContent.products,
    items: [
      {
        ...Component.defaultContent.products.items[0],
        icon: {
          ...Component.defaultContent.products.items[0].icon,
          svg:
