...
ExtendedWireframe.defaultContent = {
  ...
  topIcon: {
    svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 20"><path d="M17.513 1.667h-7.5V.833a.833.833 0 0 0-1.667 0v.834h-7.5a.833.833 0 0 0-.833.833v13.333c0 .46.373.833.834.833h3.651l-1.064 2.128a.833.833 0 1 0 1.491.745l1.437-2.873h5.636l1.436 2.873a.833.833 0 1 0 1.491-.745l-1.064-2.128h3.652c.46 0 .833-.373.833-.833V2.5a.833.833 0 0 0-.833-.833zm-2.637 5.339l-3.929 3.928a.833.833 0 0 1-1.178 0L8 9.166l-3.339 3.34a.83.83 0 0 1-1.178 0 .833.833 0 0 1 0-1.179L7.412 7.4a.833.833 0 0 1 1.179 0l1.767 1.767 3.34-3.339a.833.833 0 0 1 1.178 1.179z"/></svg>',
    fill: 'brand-color',
  },
}
