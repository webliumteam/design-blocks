...
ExtendedWireframe.defaultContent = {
  ...
  articles: [
    ...
    },
    {
      ...
      icon: {
        svg:
          '<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.3 52.3"><style>.st0{fill:none;stroke:#000;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}</style><path class="st0" d="M10.7 19.2l10.5-8.5 10.5 8.5-10.5 8.5-10.5-8.5z"/><path class="st0" d="M9.7 25.7l12 10 12-10"/><path class="st0" d="M9.7 32.7l12 10 12-10m-2-22l7.5-7.5m-4.5-1.5h6v6m-29.9 2.8L3.1 3.3M1.7 7.8l-.2-6 6-.2M31.7 41.7l7.5 7.5m-4.5 1.5h6v-6M10.8 41.8L3 49m-1.3-4.5l-.2 6 6 .2"/></svg>',
        fill: 'brand-color',
      },
    },
    {
