...
import Component from 'wireframe-series-2-careers_old/src/component'
import style from './style.css'

import defaultOptions from 'wireframe-series-2-careers_old/src/options.json'
...
ExtendedWireframe.defaultContent = {
  ...
  items: {
    ...Component.defaultContent.items,
    background: {
      'nth-child': [
        ['2n', {
          type: 'color',
          color: 'light-shade-color?darken=15',
        }],
        ['2n+1', {
          type: 'color',
          color: 'light-shade-color?darken=5',
        }],
      ],
    },
    items: [
      {
        ...Component.defaultContent.items.items[0],
        icon: {
          ...Component.defaultContent.items.items[0].icon,
      ...
      {
        ...Component.defaultContent.items.items[1],
        icon: {
          ...Component.defaultContent.items.items[1].icon,
      ...
      {
        ...Component.defaultContent.items.items[2],
        icon: {
          ...Component.defaultContent.items.items[2].icon,
