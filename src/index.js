...
import Component from 'wireframe-zapdos-why_old/src/component'
...
ExtendedWireframe.defaultContent = {
  ...
  articles: [
    ...
    },
    {
      ...
      icon: {
        svg:
          '<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.1 51.1"><style>.st0{fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}</style><title>Group 49</title><path class="st0" d="M9.1 17.5L19.6 9l10.5 8.5L19.6 26z" transform="translate(1 1)"/><path class="st0" d="M8.1 24l12 10 12-10" transform="translate(1 1)"/><path class="st0" d="M8.1 31l12 10 12-10" transform="translate(1 1)"/><path class="st0" d="M-.9 8L6.6.5M2.1-1h6v6" transform="translate(32 2)"/><path class="st0" d="M1 8.2L8.5.7M4-.8h6v6" transform="rotate(-92 6.466 4.534)"/><g><path class="st0" d="M-.9 10l7.5-7.5M2.1 1h6v6" transform="matrix(1 0 0 -1 32 51)"/></g><g><path class="st0" d="M-1 8.1L6.5.6M2-.9h6v6" transform="scale(-1 1) rotate(88 -22.746 19.805)"/></g></svg>',
        fill: 'brand-color',
      },
    },
    {
