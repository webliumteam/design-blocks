...
import Component from 'wireframe-series-2-why_old/src/component'
...
ExtendedWireframe.defaultContent = {
  ...
  why: [
    ...
    },
    {
      ...
      icon: {
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105 145"><path d="M92.5 45h-65c-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5h65c1.4 0 2.5-1.1 2.5-2.5S93.9 45 92.5 45zM27.5 65h55c1.4 0 2.5-1.1 2.5-2.5S83.9 60 82.5 60h-55c-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5zM92.5 75h-65c-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5h65c1.4 0 2.5-1.1 2.5-2.5S93.9 75 92.5 75zM82.5 90h-55c-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5h55c1.4 0 2.5-1.1 2.5-2.5S83.9 90 82.5 90zM92.5 10h-65c-1.4 0-2.5 1.1-2.5 2.5v20c0 1.4 1.1 2.5 2.5 2.5h65c1.4 0 2.5-1.1 2.5-2.5v-20c0-1.4-1.1-2.5-2.5-2.5zM90 30H30V15h60v15zM5.7 34.3c.5.5 1.2.7 1.8.7s1.3-.2 1.8-.7l10-10c1-1 1-2.6 0-3.5l-10-10c-1-1-2.6-1-3.5 0-1 1-1 2.6 0 3.5l8.2 8.2-8.2 8.2c-1 1-1 2.6-.1 3.6z"/></svg>',
        fill: 'brand-color',
      },
    },
    {
